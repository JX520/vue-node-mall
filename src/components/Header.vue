<template>
    <header class="header">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-link" @click="showLogin" v-if="!nickName">登录</a>
                    <a href="javascript:void(0)" class="navbar-link" @click="outLogin" v-if="nickName">退出</a>
        ...
        <div class="md-modal modal-msg md-modal-transition md-show" v-show="Login">
        ...
        <div class="md-overlay" v-show="Login" @click="closeLogin"></div>
    </header>
</template>
