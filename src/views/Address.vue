    ...
    <div class="checkout-page">
      ...
      <div class="container">
        <div class="checkout-addr">
            ...
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" :key="item.id"
                  v-bind:class="{'check':checkIndex == index}" @click="checkIndex = index;selectAddId =item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <!-- shipping method-->
          <div class="page-title-normal checkout-title">
            <h2><span>选择物流</span></h2>
          </div>
          <div class="shipping-method-wrap">
            <div class="shipping-method">
              <ul>
                <li class="check">
                  <div class="name">普通方式</div>
          ...
          <div class="next-btn-wrap">
            ...
            <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',query:{'addressId':selectAddId}}">确认支付</router-link>
          </div>
        </div>
      </div>
    </div>

    <Modal :md-show="modalDelete" @close="closeModal">
      <p slot="message">确认删除该地址吗？</p>
      <div slot="btnGroup">
        <a class="btn btn--m" @click="deleteAddress">确认</a>
        <a class="btn btn--m" @click="modalDelete = false">取消</a>
      </div>
    </Modal>
