<template>
  <div>
    ...
    <div class="accessory-result-page accessory-page">
      <div class="container">
        <div class="filter-nav">
          ...
          <a href="javascript:void(0)" class="price" @click="sortGoods">价格 <svg class="icon icon-arrow-short"
        ...
        <div class="accessory-result">
          ...
          <div class="filter stopPop" id="filter" v-bind:class="{'filterby-show':filterBy}">
            <dl class="filter-price">
              ...
              <dd><a href="javascript:void(0)" v-bind:class="{'cur':priceChecked == 'All'}"
                  @click="priceChecked = 'All'">全部</a></dd>
          ...
          <div class="accessory-list-wrap">
            <div class="accessory-list col-4">
              ...
              <div class="load-more" v-show="bottom">
                已加载到底部！
              </div>
    ...
    <modal v-bind:mdShow="mdShowCart" v-on:close="closeModal">
      ...
      <div slot="btnGroup">
        <a class="btn btn--m" @click="closeModal">继续浏览</a>
    ...
    methods: {
      ...
      getGoodsList(flag) {
        ...
        axios.get("/goods/list", {
          ...
          if (res.status == '0') {
            if (flag) {
              this.goodsList = this.goodsList.concat(res.result.list);//若为分页查询，则需数据连接
